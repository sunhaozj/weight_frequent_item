...
from pyfpgrowth.weightfpgrowth import FPNode,WeightfPTree
...
class FPNodeTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        """
        self.node = FPNode(1, 2, None,None)
        self.node.add_child(2,1)
...
class FPTreeTests(unittest.TestCase):
    ...
    def test_build_header_table(self):
        ...
        """
        tree = WeightfPTree([], 3,1, None, None)
...
class FPGrowthTests(unittest.TestCase):
    ...
    def test_find_frequent_patterns(self):
        patterns = find_frequent_patterns(self.transactions, self.support_threshold,self.weight_threshold,{1:0.8,3:0.8,2:0.5,4:1},0.5)

        expected = {(1, 2): 4, (1, 2, 3): 2, (1, 3): 4, (1,): 6, (2,): 7, (2, 4): 2,
                    (1, 5): 2, (5,): 2, (2, 3): 4, (2, 5): 2, (4,): 2, (1, 2, 5): 2}

        print(patterns)
        #self.assertNotEqual(patterns, expected)
